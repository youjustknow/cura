        ...
        header.innerHTML = `
            <div class="shift-info">
                <div class="shift-time">
                    ...
                    <span class="shift-value">${shift.startTime.toLocaleTimeString('ru-RU', {hour: '2-digit', minute: '2-digit', second: ''})} - ${shift.endTime ? shift.endTime.toLocaleTimeString('ru-RU', {hour: '2-digit', minute: '2-digit', second: ''}) : 'Не завершена'}</span>
